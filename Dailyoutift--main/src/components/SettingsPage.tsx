import { AlertTriangle, CreditCard, Crown, Loader2, LogOut, Settings, ShieldCheck, Trash2, Wand2 } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      <section className="bg-white border border-gray-100 rounded-2xl shadow-sm p-5 space-y-4">
        ...
        <div className="grid gap-3 text-sm text-gray-500 leading-relaxed">
          ...
          <p>Local browser storage is used only as a temporary cache and recovery layer. It should never overwrite your cloud data.</p>
        </div>
      </section>
